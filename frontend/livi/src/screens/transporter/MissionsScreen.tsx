...
import { Card, Button, CountdownTimer, EmptyState } from '../../design/components';
        ...
        return (
          <Pressable onPress={() => navigation.navigate('MissionDetails', { missionId: item.id })}>
            <Card style={[styles.card, isOffer && styles.offerCard]}>
              ...
              {item.shipping_fee != null && <Text style={styles.meta}>Frais de livraison : {Number(item.shipping_fee).toLocaleString('fr-FR')} FCFA</Text>}
              {isOffer && (
