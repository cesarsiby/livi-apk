...
import { Card, Button, CountdownTimer, EmptyState, Skeleton, formatMoney } from '../../design/components';
...
export function MissionsScreen({ navigation }: any) {
  ...
  // SESSION 26 (améliorations UX/UI) : même conversion ActivityIndicator →
  // Skeleton qu'InventoryScreen, repérée par la même recherche systématique.
  if (loading) return (
