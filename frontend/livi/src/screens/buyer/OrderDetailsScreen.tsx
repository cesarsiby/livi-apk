...
import { Button, CountdownTimer, Money, RatingPrompt, StatusBadge } from '../../design/components';
...
export function OrderDetailsScreen({ route, navigation }: any) {
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.container}>
      ...
      <Money amount={order.total_amount ?? order.total} currency={order.currency ?? 'FCFA'} size="lg" style={styles.total} />
