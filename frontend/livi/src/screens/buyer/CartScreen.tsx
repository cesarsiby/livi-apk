...
import { Button, EmptyState, Money, formatMoney } from '../../design/components';
    ...
    <View style={styles.container}>
          ...
          return (
            <View style={styles.row}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.meta}>{formatMoney(price)} × {item.quantity}</Text>
              </View>
      ...
      <View style={styles.footer}>
        <View style={styles.totalRow}>
          ...
          <Money amount={subtotal} size="lg" color={colors.gold} />
        </View>
        <Button
...
const styles = StyleSheet.create({
  ...
  totalLabel: { fontFamily: fonts.brand, fontSize: fontSize.xl, color: colors.textPrimary },
});
