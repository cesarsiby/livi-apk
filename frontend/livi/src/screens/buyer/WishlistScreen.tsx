...
import { Card, EmptyState, Money, Skeleton } from '../../design/components';
    ...
    <FlatList
      ...
      renderItem={({ item }) => (
        <Card style={s.card}>
          ...
          {item.price != null ? <Money amount={item.price} currency={item.currency ?? 'FCFA'} size="sm" style={s.price} /> : <Text style={s.price}>—</Text>}
