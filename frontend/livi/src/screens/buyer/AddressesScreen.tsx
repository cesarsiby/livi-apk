...
export function AddressesScreen() {
  ...
  const [form, setForm] = useState<any>({ label: '', recipient_name: '', phone: '', address_line: '', city: '', country: 'Mali', is_default: false, neighborhood: '', landmark_type: '', landmark_description: '' });
  ...
  const open = (a?: any) => {
    setEditing(a ?? null);
    setForm(a ? { ...form, ...a } : { label: '', recipient_name: '', phone: '', address_line: '', city: '', country: 'Mali', is_default: false, neighborhood: '', landmark_type: '', landmark_description: '' });
    setModal(true);
  };
