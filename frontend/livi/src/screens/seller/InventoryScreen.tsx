...
export function InventoryScreen() {
  ...
  // SESSION 26 (améliorations UX/UI) : était un ActivityIndicator plein
  // écran (faisait disparaître toute la mise en page pendant le
  // chargement) — seul écran de ce type resté sur cet ancien motif,
  // repéré par recherche systématique. Même Skeleton que les autres
  // écrans de liste déjà migrés (voir OrdersScreen.tsx).
  if (loading) return (
    <View style={s.list}>
